...
function showUpdateDialog(object){
    ...
    selectedId = object.paren2Id //"gemmer" id på selected teacher når man trykker update
...
//send PUT
async function update(paren2Id, name){
    const object = {paren2Id, name} //husk rigtig id navn når json objekt laves!! ellers 404
